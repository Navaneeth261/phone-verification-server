...
export const ENCRYPTION_KEY = process.env.ENCRYPTION_KEY; // Key used for encryption/decryption
...
export const ENCRYPT_REQ_RES = process.env.ENCRYPT_REQ_RES === 'true'; // Whether or not to encrypt the requesta and response data
